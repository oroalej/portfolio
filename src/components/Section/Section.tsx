...
export const SectionWrapper = ({children, id, className = ''}: SectionWrapperInterface) => (
    <div
        className={classNames("py-14 md:py-20 lg:py-32 dark:text-neutral-300", className)}
        id={id}
    >
        <Container>
            {children}
...
export const SectionTitle = ({children, anchor, className = ''}: SectionTitleInterface) => (
    <div className={classNames("flex flex-row gap-2 items-center mb-4", className)}>
