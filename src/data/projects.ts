export const PROJECT_LIST = [
  {
    ...
    type: "personal",
    description:
      "Updating the previous project to community based curation via voting. Integrating Algorand blockchain and its ecosystem",
    uses: [
      "HTML5",
      "CSS3",
      "TailwindCSS",
  ...
  },
  {
    ...
    type: "personal",
    description:
      "This is a ongoing personal project. I created this to refresh my skills in Laravel and to practice test driven design (TDD), testing in general, action pattern, data transfer object (DTO), and OOP fluent interface. This project was also created to suit my needs as I am now managing the finances at home.",
    uses: [
      "HTML5",
      "CSS3",
      "TailwindCSS",
  ...
  },
  {
    ...
    type: "personal",
    description:
      "This is a revamped portfolio of mine. A virtual world I can confidently say is  my creation.\n",
  ...
  },
  {
    ...
    type: "personal",
    description:
      "This is an unofficial curation of tools, projects, and resources that are relevant to the Algorand ecosystem.",
  ...
  },
  {
    ...
    type: "freelance",
    description:
      "This is an MVP of a system-as-a-software customer loyalty program platform for small and medium enterprises.",
  ...
  },
  {
    ...
    type: "freelance",
    description:
      "A simple content management system. The backend design was inspired by wordpress.com.",
    ...
    screenshots: [
      ...
      },
      {
        ...
        filename:
          "thriving-in-between/thriving-in-between-backend-blog-list.jpg",
        width: 1902,
        height: 941,
      },
      {
        ...
        filename:
          "thriving-in-between/thriving-in-between-backend-create-blog.jpg",
        width: 1905,
        height: 940,
      },
      {
      ...
      },
      {
        ...
        filename:
          "thriving-in-between/thriving-in-between-backend-gallery-page.jpg",
        width: 1900,
        height: 938,
      },
      {
        ...
        filename:
          "thriving-in-between/thriving-in-between-backend-gallery-preview.jpg",
        width: 1902,
        height: 938,
      },
    ],
  },
  {
    ...
    type: "freelance",
    description:
      "A point-of-sale, inventory, reports, and sales return system to be used internally by a local poultry farm.",
    uses: [
      "HTML5",
      "CSS3",
      "Codeigniter",
