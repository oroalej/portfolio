...
import QuotesTable from "@/app/admin/quotes/(Index)/_components/QuotesTable";
import { Suspense } from "react";
import AdminQuoteListPage from "@/app/admin/quotes/(Index)/loading";
import TableFilter from "@/app/admin/quotes/(Index)/_components/TableFilter";
  ...
  <Suspense fallback={<AdminQuoteListPage />}>
    <div className="max-w-screen-2xl mx-auto py-14">
      <div className="flex justify-end mb-4">
        <Button href="/admin/quotes/create">Add Quote</Button>
      </div>
