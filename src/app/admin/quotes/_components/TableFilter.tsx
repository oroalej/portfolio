...
import {Button, CardBody, CardFooter, CardHeader, CardRoot, CardTitle, FormGroup, Label} from "@/components";
...
const TableFilter = () => {
    ...
    const [sourceId, setSourceId] = useState<string>(searchParams.get('source_id') || "");
    const [mediaDetailId, setMediaDetailId] = useState<string>(searchParams.get('media_detail_id') || "");
        ...
        <CardRoot className="w-72 shrink-0">
            ...
            <CardBody className="flex flex-col grow">
                <FormGroup>
                    ...
                    <CategorySearchableSelect value={categoryId} onChange={(value) => {
                        setCategoryId(value);
                        setSourceId("");
                        setMediaDetailId("");
                    }}/>
