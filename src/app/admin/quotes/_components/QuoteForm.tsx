...
import {Button, CardBody, CardFooter, CardHeader, CardRoot, CardTitle, FormGroup, Label, Textarea} from "@/components";
...
const formLabelByCategory: Record<string, { source: string, media_detail: string }> = {
            ...
            <fieldset>
                <CardRoot>
                    ...
                    <CardBody>
                        ...
                        <FormGroup>
                            <Label>
                                {formLabelByCategory[watch('category_id')]?.media_detail || "Name"}
                            </Label>
