        ...
        <div
            ...
            <div className="max-w-screen-2xl mx-auto">
                <div className="z-50 flex justify-between items-center flex-row w-full">
                    ...
                    <div
                        className="fixed inset-0 z-[100] mt-[72px] md:flex flex-row items-center justify-between flex-1 md:relative md:mt-0 dark:bg-slate-800 bg-neutral-100">
                        ...
                        <div className="flex flex-col items-center justify-center md:flex-row gap-4 mt-24 md:mt-0 px-1">
                            ...
                            <NavLink active={pathname.startsWith('/admin/projects')}
                                     href="/admin/projects">Projects</NavLink>
                            <NavLink active={pathname.startsWith('/admin/quotes')} href="/admin/quotes">Quotes</NavLink>
                            <NavLink active={pathname.startsWith('/admin/daydreams')}
                                     href="/admin/daydreams">Daydreams</NavLink>
                        </div>
