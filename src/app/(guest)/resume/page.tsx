    ...
    <div className="font-sans py-14 md:py-20 lg:pb-32">
        <Container>
            ...
            <div className="w-full mb-12 lg:mb-6 text-center lg:text-right">
                <a href="https://drive.google.com/file/d/1Y_7k8PR-q1XlO-Bxaklcc9kDO8_qNopE/view?usp=sharing"
                   target="_blank"
            ...
            <div className="divide-y-2">
                <div className="pb-6 lg:pb-10">
                    ...
                    <p className="dark:text-neutral-400 mt-3 lg:mt-6 text-sm lg:text-base">
                        Innovative developer with 5 years of professional experience in object-oriented programming,
                        implementing design interfaces, testing, and debugging. Passionate about technology and learning
                        new things.
                    </p>
                </div>
                <div className="flex flex-col lg:flex-row lg:gap-28 pt-6 lg:pt-10">
                    <div className="w-full lg:w-2/3">
                        <h2 className="text-lg lg:text-2xl dark:text-neutral-200 text-neutral-700">Professional
                            Experiences</h2>
                        {
                            EXPERIENCES.map(({company, positions, descriptions, technologies = []}) => (
                                <div className="relative block py-3 space-y-0.5 text-sm lg:text-base"
                                    ...
                                    <h3 className="text-neutral-700 font-medium dark:text-neutral-200 text-lg">{company}</h3>
                                    {
                                        positions.map(({title, duration}) => (
                                            <div
                                                ...
                                                <span
                                                    className="w-0.5 h-3.5 relative bg-neutral-400 hidden md:block"/>
                                    ...
                                    <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-200 space-y-2 pb-2">
                                        {
                                            descriptions.map((description, index) => (
                                                <li key={kebabCase(company, index.toString())}>{description}</li>
                                            ))
                                        }
                                    </ul>
                    ...
                    <div className="w-full lg:w-1/3 space-y-5 mt-4 lg:mt-0">
                        <div className="relative">
                            ...
                            <div className="space-y-2">
                                <div
                                    className="flex items-center flex-row text-neutral-700 dark:text-neutral-200 space-x-1.5">
                                    <FaEnvelope size={20}/>
                                ...
                                <div
                                    className="flex items-center flex-row text-neutral-700 dark:text-neutral-200 space-x-1.5">
                                    <FaLinkedin size={21}/>
                                    <a href="src/pages/resume" rel="noreferrer" target="_blank"
