...
import {ExternalLink, Section, SectionTitle} from "@/components";
import {SiLinkedin, SiTwitter} from "react-icons/si";

const ContactMeSection = () => {
    return (
        <Section className="rounded-tl-lg rounded-tr-lg bg-neutral-900 text-neutral-300" id="contacts">
            ...
            <p className="text-sm xs:text-base mb-2 text-opacity-80 md:w-2/3">
                If you have open positions that you think will fit well with my skill set or if you have any questions,
            ...
            <div className="text-sm sm:text-base mt-10">
                ...
                <a href={`mailto:${EMAIL_ADDRESS}`}
                   className="mb-8 inline-block hover:text-white">{EMAIL_ADDRESS}</a>
                ...
                <div className="flex flex-row gap-8">
                    ...
                    <ExternalLink href={LINKED_IN_LINK} label="LinkedIn"
                    ...
                    <ExternalLink href={TWITTER_LINK} label="Twitter"
                                  className="hover:text-white transition-colors">
                        <SiTwitter size={22}/>
                    </ExternalLink>
                </div>
